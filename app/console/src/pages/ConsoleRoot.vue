...
/** /console 下所有页面的入口：先取身份，未登录去 /signin，没有任何能力显示 guest 的说明。 */
const { me, meError, meLoading, catalogue, reload } = useSession();
...
<template>
  ...
  <div v-else-if="guest && me" class="root-state console-ground">
    <TxCard class="guest">
      ...
      <p>加入 GitHub 组织后刷新本页；或者请{{ assignerText(catalogue) }}在「成员与权限」里给你指派称号。</p>
