...
const SERVER_TITLES = {
  admin: { label: '提督', tag: 'ADMIRAL', icon: 'user-admin', tone: 'violet', rank: 0, description: 'GitHub 组织的 owner，拥有全部能力，任命舰长' },
  ...
  member: { label: '舰员', tag: 'CREW', icon: 'code', tone: 'sky', rank: 5, description: '在读成员；GitHub 组织的 active 成员自动获得' },
