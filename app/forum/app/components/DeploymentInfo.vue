...
<template>
  <TxCard>
    ...
    <TxStack :gap="12">
      ...
      <p>预发布：<a :href="deployment.previewOrigin" class="text-$tx-color-primary underline" target="_blank" rel="noopener noreferrer">prev.yangtzeu.work</a>，对应 <code>stage</code> 分支，版本显示为 X.Y.Z@提交前 12 位。</p>
      <p>正式：<a :href="deployment.productionOrigin" class="text-$tx-color-primary underline" target="_blank" rel="noopener noreferrer">yangtzeu.work</a>，对应 <code>main</code> 分支，版本显示为 X.Y.Z。</p>
