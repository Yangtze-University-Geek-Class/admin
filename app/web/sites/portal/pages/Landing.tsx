      ...
      <main>
        ...
        {features.mascotPreview && <section className="portal-section portal-container portal-mascot-lab">
          <div className="portal-mascot-copy">
            ...
            <h2>极客娘，不只是装饰。</h2>
            <p>模块已支持 8 套姿势、随机对话和页面场景映射。主站与论坛统一为右下角同尺寸展示。此板块仅开发环境可见，生产环境不展示；如需调整，修改 <code>app/web/shared/config/app.config.json</code> 中 <code>features.production.mascotPreview</code>。</p>
          </div>
