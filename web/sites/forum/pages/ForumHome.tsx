      ...
      <aside className="space-y-5">
        ...
        <div className="card p-5">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href={externalUrl("portal", "/docs")} className="text-ink-100 hover:text-brand-500">使用文档</a></li>
            <li><a href={externalUrl("portal", "/feedback")} className="text-ink-100 hover:text-brand-500">提交意见</a></li>
          </ul>
        </div>
      </aside>
    </div>
