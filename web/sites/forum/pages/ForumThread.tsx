...
import { renderForumContent } from "@shared/lib/markdown";
...
export default function ForumThread() {
  ...
  const threadHtml = useMemo(() => t ? renderForumContent(t.content, t.content_format) : "", [t?.content, t?.content_format]);
  ...
  return (
    <div ref={articleRef} className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="space-y-3">
        {posts.map((p, idx) => {
          const html = renderForumContent(p.content, p.content_format);
