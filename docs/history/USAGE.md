...
当前版本：[../ops/USAGE.md](../ops/USAGE.md)。
...
- 主站顶部延续原版信息架构：左侧 Logo 和“长江大学极客班”返回主页；右侧依次为文档、论坛、管理后台、GitHub，移动端折为两列两行入口。
- 首页末尾的看板娘实验区可切换 8 套姿势并点击角色查看对话，仅开发环境可见，生产环境不展示。
- 主站与论坛看板娘统一规格与尺寸（154×245），固定右下角；聊天文字位于意见按钮上方独立的固定大小透明面板中，文本超长时可在面板内滚动。论坛按首页、分类、帖子、归档和管理页面切换姿势与对话。
